<section id="header_top">
  ...
  <div id="bg-tb" class="slidetb">
    ...
    <img class="vhp" src="<?=base_url() ?>_assets/img/prewed/rk_2_c.jpg" alt="">
    <!-- <img class="vpc" src="<?=base_url() ?>_assets/img/demos/wedding/foto/ami_bokeh.png" alt=""> -->
    <img class="vpc" src="<?=base_url() ?>_assets/img/prewed/rk-c.jpg" alt="">
  ...
  <!-- <div class="col-md-12 pt-xlg center"> -->
    <div class="row card_text loading_card zoomIn durationtb2" data-appear-animation="zoomIn" data-appear-animation-delay="0">
      ...
      <div class="content_card col-md-12">
        <h4 class="text-color-primary center">Kolose 3:14-15</h4>
