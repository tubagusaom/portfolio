...
<audio id="audio1" controls autoplay loop preload controlsList="nodownload" >
  <source src="<?=base_url()?>_assets/audio/isyana_sarasvati-rayhan_maditra-1-1.mp3" type="audio/mp3"></source>
</audio>
      ...
      <section class="jumbotron text-center">
        <div class="font-display">
          ...
          <section class="section-imgtb">
            <img class="imageicontb1 animated zoomIn" data-appear-animation="zoomIn" data-appear-animation-delay="50" src="<?=base_url()?>_assets/img/logo-rk-01.png" alt="" />
          </section><br>
