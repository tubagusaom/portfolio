...
?>
	...
	<table>
		<tr>
			<td align="center">
				<h2 style="color:darkblue; font-size:20px; text-shadow: 1px 1px 2px red; background-color:#fff; width:33%;box-shadow: 1px 1px 3px #000;">
					<?php
						die('FILE ' . $sFileName . ' TIDAK BISA DILIHAT');
					?>
				</h2>
			</td>
		</tr>
