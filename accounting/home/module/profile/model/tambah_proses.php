<?php //*fungsi simpan
	if (isset($_POST['simpan']))
	{
		...
		if ($querya) {
			echo "<script>alert('Pinjaman Berhasil Ditambahkan tunggu aprove, !'); location.href='?Profile-Pinjaman&&header=Profile';</script>";
		}else {
			echo "<script>alert('Pinjaman Gagal Ditambahkan'); location.href='?Profile-Pinjaman&&header=Profile'</script>";
		}
	};
?>
