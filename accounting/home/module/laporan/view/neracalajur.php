...
<table>
  ...
  <tr class="hover" bgcolor="<?php echo "$warna" ?>">
    ...
    <?php
      ...
      $sqlformula_1  	="SELECT `kd_acount`, `kd_group`, `jenis_formula` FROM `report_formula` WHERE kd_group = '$datagroup_1[0]' AND stts_formula NOT LIKE '3'";
      ...
      $sqlformula_2  	="SELECT `kd_acount`, `kd_group`, `jenis_formula` FROM `report_formula` WHERE kd_group = '$datagroup_2[0]' AND stts_formula NOT LIKE '3'";
      ...
      $sqlformula_3  	="SELECT `kd_acount`, `kd_group`, `jenis_formula` FROM `report_formula` WHERE kd_group = '$datagroup_3[0]' AND stts_formula NOT LIKE '3'";
      ...
      $sqlformula_4  	="SELECT `kd_acount`, `kd_group`, `jenis_formula` FROM `report_formula` WHERE kd_group = '$datagroup_4[0]' AND stts_formula NOT LIKE '3'";
