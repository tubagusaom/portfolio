<?php
  ...
  if ($penarikan > $ssrela) {
    ...
    if ($query){
      echo "<script>alert('PENARIKAN SEDANG DIPROSES....!!'); location.href='?Detail-Simpanan&&header=Simpanan&&kode=$c&&kodea=$d&&namaa=$e'</script>";
    }else {
      echo "<script>alert('PENARIKAN GAGAL DIPROSES....!!'); location.href='?Detail-Simpanan&&header=Simpanan&&kode=$c&&kodea=$d&&namaa=$e'</script>";
    }
  }
?>
