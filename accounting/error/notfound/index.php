<?php
  ...
  $base_home = str_replace('error/notfound/','', $base_url);
  ...
  <body>
    ...
    <div class="container">
      <div class="error">
        ...
        <p><font class="font1">Halaman yang anda cari tidak ditemukan, namanya berubah atau tidak tersedia untuk sementara</font></p>
        <p><font class="font2">Halaman yang anda cari tidak ditemukan</font></p>
        <p>Silahkan coba untuk <a href="<?=$base_home?>">KEMBALI</a> atau kembali ke <a href="<?=$base_home?>">BERANDA</a> </p>
