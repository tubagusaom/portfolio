...
class Vm_administrasi_ujk extends MY_Controller {

	function __construct() {
		parent::__construct();
		// has_privilege($this->uri->segment(1));
		$this->load->model('vm_administrasi_ujk_model');
        $this->load->library('pagination');
	}

	function index(){
        $data = [
			'konten' => 'vm_administrasi_ujk/index',
	...
	function datagrid(){
		...
		$data['record'] = $this->vm_administrasi_ujk_model->data_jadwal();

		// var_dump($data); die();
        
        $view = $this->load->view('vm_administrasi_ujk/grid',$data,TRUE);
        echo json_encode([
            'tabel' => $view
        ]);
    }
    ...
    function tambah(){
        ...
        $view = $this->load->view('vm_administrasi_ujk/tambah',TRUE);
    ...
    function edit($id){
        ...
        $view = $this->load->view('vm_administrasi_ujk/edit',$data,TRUE);
        echo json_encode($view);
    }
