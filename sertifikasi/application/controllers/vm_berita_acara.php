...
class Vm_berita_acara extends MY_Controller {

	function __construct() {
		parent::__construct();
		// has_privilege($this->uri->segment(1));
		$this->load->model('vm_berita_acara_model');
        $this->load->library('pagination');
	}

	function index(){
        $data = [
			'konten' => 'vm_berita_acara/index',
	...
	function datagrid(){
		...
		$data['record'] = $this->vm_berita_acara_model->data_jadwal();

		// var_dump($data); die();
        
        $view = $this->load->view('vm_berita_acara/grid',$data,TRUE);
        echo json_encode([
            'tabel' => $view
        ]);
    }
    ...
    function tambah(){
        ...
        $view = $this->load->view('vm_berita_acara/tambah',TRUE);
    ...
    function edit($id){
        ...
        $view = $this->load->view('vm_berita_acara/edit',$data,TRUE);
        echo json_encode($view);
    }
