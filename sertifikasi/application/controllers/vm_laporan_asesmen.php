...
class Vm_laporan_asesmen extends MY_Controller {

	function __construct() {
		parent::__construct();
		// has_privilege($this->uri->segment(1));
		$this->load->model('vm_laporan_asesmen_model');
        $this->load->library('pagination');
	}

	function index(){
        $data = [
			'konten' => 'vm_laporan_asesmen/index',
	...
	function datagrid(){
		...
		$data['record'] = $this->vm_laporan_asesmen_model->data_jadwal();

		// var_dump($data); die();
        
        $view = $this->load->view('vm_laporan_asesmen/grid',$data,TRUE);
        echo json_encode([
            'tabel' => $view
        ]);
    }
    ...
    function tambah(){
        ...
        $view = $this->load->view('vm_laporan_asesmen/tambah',TRUE);
    ...
    function edit($id){
        ...
        $view = $this->load->view('vm_laporan_asesmen/edit',$data,TRUE);
        echo json_encode($view);
    }
